...
export interface RecordCertificateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
  ...
  encodeFunctionData(
    functionFragment: "tokenIdByRecordId",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export namespace CertificateIssuedEvent {
  ...
  export type OutputTuple = [tokenId: bigint, recordId: bigint, to: string];
  export interface OutputObject {
    tokenId: bigint;
    recordId: bigint;
    to: string;
...
export interface RecordCertificate extends BaseContract {
  connect(runner?: ContractRunner | null): RecordCertificate;
  waitForDeployment(): Promise<this>;

  interface: RecordCertificateInterface;
  ...
  issueCertificate: TypedContractMethod<
    [recordId: BigNumberish, to: AddressLike],
    [bigint],
    "nonpayable"
  >;
  ...
  tokenIdByRecordId: TypedContractMethod<
    [arg0: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "tokenIdByRecordId"
  ...
  filters: {
    ...
    "CertificateIssued(uint256,uint256,address)": TypedContractEvent<
      CertificateIssuedEvent.InputTuple,
      CertificateIssuedEvent.OutputTuple,
      CertificateIssuedEvent.OutputObject
    >;
